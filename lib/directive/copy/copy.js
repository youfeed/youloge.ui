  ...
  mounted(el, binding, vnode, prevVnode){
    ...
    el.onclick = (e)=>{
      ...
      const addend = (txt,color)=>{
        ...
        Fragment.setAttribute('style',`color: ${color};position: fixed;left:${clientX}px;top:${clientY}px;transform:translate(-50%,-50%);`);
        Fragment.animate([
...
export default {name:'copy',use:useCopy}