...
const globFunctions = import.meta.glob(['./functions/*/index.js'],{eager: true,import: 'default'});
...
// 函数组件
Object.entries(globFunctions).forEach(([path,asyncModule])=>{
...
// export const {...exported} = {...functions,...directives,...components};
