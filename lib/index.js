...
const functions = {useLoading,useFetch,useMessage,useDialog,usePayment,usePlus,useCaptcha,useLogin}
export { useLoading,useFetch,useMessage,useDialog,usePayment,usePlus,useCaptcha,useLogin };
// 指令函数
...
import yRgba from "./components/rgba";
...
const components = {yAd,hashView,yHeader,yRich,yDiscuss,yRgba,yVideo,yLogin,yPayment,yGoods};
export {yAd,hashView,yHeader,yRich,yDiscuss,yRgba,yVideo,yLogin,yPayment,yGoods}
// 不要自动安装插件：要配置参数
