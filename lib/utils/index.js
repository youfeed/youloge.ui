...
* 图片URL处理
*/
export const useImage = (uuid,size=80)=>{
...
* 字面量时间
*/
export const useTimeago = (t,offset=0) =>{
...
export default {
    useConfig,useStorage,useProfile,apiFetch,vipFetch,useImage,
    useLogged,useBytes,useTimeago
}