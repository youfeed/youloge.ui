...
const components = {yAd,hashView,yHeader,yRich,yDiscuss,yRgb,yVideo,yLogin,yPayment,yGoods,ySearch};
export {yAd,hashView,yHeader,yRich,yDiscuss,yRgb,yVideo,yLogin,yPayment,yGoods,ySearch}
// 不要自动安装插件：要配置参数
