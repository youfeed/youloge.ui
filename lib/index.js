...
const components = {HashView,yAd,yHeader,yRich,yDiscuss,yRgb,yVideo,yLogin,yPayment,ySearch};
export {HashView,yAd,yHeader,yRich,yDiscuss,yRgb,yVideo,yLogin,yPayment,ySearch}
// 不要自动安装插件：要配置参数
//
